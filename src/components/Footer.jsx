          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                I am Developer & Computer Science Engineering Student
              </p>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span>chaandanverma@gmail.com</span>
              </a>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-12 h-12 rounded-xl bg-gray-800 border border-gray-700 flex items-center justify-center hover:bg-indigo-600 hover:border-indigo-400 transition-all duration-300 group"
                  title="Call me"
                >
                ...
                {/* Instagram */}
                <motion.a
                  href="https://www.instagram.com/__mr._chand__810__?igsh=MWRwamRxc3NvaG9tNw=="
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.1, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                  className="w-12 h-12 rounded-xl bg-gray-800 border border-gray-700 flex items-center justify-center hover:bg-pink-600 hover:border-pink-400 transition-all duration-300 group"
                >
                  <svg className="w-6 h-6 text-gray-400 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
